...
export const MainRoutes: Routes = [
    ...
    { path: "school/eduadmin-view", component: EduadminView, canActivate: [EduAdminAuthGuard, EduDistribAuthGuard] },
    { path: "school/mergeschools", component: MergeSchools, canActivate: [DidepdeAuthGuard, EduDistribAuthGuard] },
    { path: "school/undomerge", component: UndoMergeSchools, canActivate: [DidepdeAuthGuard, EduDistribAuthGuard] },
