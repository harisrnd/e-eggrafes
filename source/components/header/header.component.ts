...
import { DIDE_ROLE, MINISTRY_ROLE, PDE_ROLE, SCHOOL_ROLE, STUDENT_ROLE, SCHOOLGEL_ROLE } from "../../constants";
...
export default class HeaderComponent implements OnInit, OnDestroy {
    ...
    signOut() {
        ...
        this._hds.signOut().then(data => {
            ...
            if (this.authRole === SCHOOL_ROLE || this.authRole === SCHOOLGEL_ROLE) {
                this.authToken = "";
                this.authRole = "";
