...
@Component({
  ...
  <div>
       ...
       -->
            ...
            Εναλλακτικά μπορείτε να καλέσετε στις ακόλουθες τηλεφωνικές γραμμές:
                <ul>
                <li> <strong>ΓΕΛ:</strong> 2103443911 (ώρες: 8:00 - 16:00)</li>
                <li> <strong>ΕΠΑΛ:</strong> 2103443913 (ώρες: 8:00 - 16:00)</li>
                </ul>
            <p>
