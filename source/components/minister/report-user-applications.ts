...
@Component({
    selector: "report-user-applications",
    template: `
...
@Injectable() export default class ReportUserApplications implements OnInit, OnDestroy {
    ...
    createReport(regionSel) {
        ...
        this.validCreator = 0;
        let route = "/ministry/report-user-applications/";
