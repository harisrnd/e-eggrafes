...
@Component({
    ...
    template: `
        ...
        <p align="left">
        Σε περίπτωση που αντιμετωπίζετε οποιοδήποτε πρόβλημα με την καταχώριση της αίτησης σας,
         παρακαλούμε να διαβάσετε τις απαντήσεις σε συχνές ερωτήσεις 
        που θα βρείτε μέσω της επιλογής «ΣΥΧΝΕΣ ΕΡΩΤΗΣΕΙΣ» στο πλαίσιο αριστερά.</p>
        <p align="left"> Αν δεν μπορέσετε να βρείτε απάντηση μέσω της επιλογής 
        «ΣΥΧΝΕΣ ΕΡΩΤΗΣΕΙΣ» , παρακαλούμε συμπληρώστε τη φόρμα περιγράφοντας 
        το πρόβλημα που αντιμετωπίζετε, <strong>αναφέροντας το μήνυμα </strong>που σας 
        εμφανίζει η εφαρμογή και επιπλέον:</p>
            <ul> <strong> 
            <li> τον Αριθμό Μητρώου,</li>
            <li> την ημερομηνία γέννησης και </li>
            <li> το σχολείο τελευταίας φοίτησης του μαθητή. </li>
            </strong>
            </ul> 
