...
@Component({
    ...
    Έχετε επιλέξει περισσότερες από μία Ξένες Γλώσσες. Καθορίστε εδώ την επιθυμητη σειρά προτίμησης πατώντας τα αντίστοιχα βέλη δεξιά από τα ονόματα των Ξένων Γλωσσών.
