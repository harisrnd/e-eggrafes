...
@Component({
    selector: "report-gel-distrib",
    template: `

    <div class="reports-container">
        <div class = "loading" *ngIf="validCreator == 0" ></div>
        <h5>Τοποθετήσεις Μαθητών</h5>
...
@Injectable() export default class ReportGelDistrib implements OnInit, OnDestroy {
    ...
    createReport() {
        this.validCreator = 0;
        let route = "/dide/didegel-distrib-report";
        this.settings = this.reportSchema.reportDideGelDistrib;
